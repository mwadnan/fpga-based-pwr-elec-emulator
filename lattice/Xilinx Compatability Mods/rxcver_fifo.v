...
module rxcver_fifo (Data, Clock, WrEn, RdEn, Reset, Q, Q_error, Empty, Full,
   ...
   wire[7:0] Q_node; 
	...
	wire [3:0] data_count;
	  ...
	  assign AlmostEmpty = Empty;
	  assign AlmostFull = data_count[0];		//HIGH when data_count>=1
	  
	  uart_fifo rx_fifo_inst (
		  .clk(Clock), // input clk
		  .srst(Reset), // input srst
		  .din(Data[10:3]), // input [7 : 0] din
		  .wr_en(WrEn), // input wr_en
		  .rd_en(RdEn), // input rd_en
		  .dout(Q_node), // output [7 : 0] dout
