...
#define STATE_UPDATE_S1_BASEADDR	0x00008000
#define STATE_UPDATE_S2_BASEADDR	0x00010000
 ...
 *  STATE_UPDATE_S2
 */
#define S2_CONTROL					(STATE_UPDATE_S2_BASEADDR + 0x400)
#define S2_STATUS					(STATE_UPDATE_S2_BASEADDR + 0x400)
#define S2_COEFF_BASEADDR			(STATE_UPDATE_S2_BASEADDR + 0x000)
